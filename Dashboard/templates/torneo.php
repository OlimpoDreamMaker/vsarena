    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-primary">
              <div class="inner">
              <?php
              require_once("../php/cantidadInscriptosTorneo.php");
              $conexion = conectar();
        ...
        <div class="row">
          ...
          $conexion = conectar();
          if($tipoPart=="Equipo"){
            require_once("../php/tablasEquiposInscriptos.php"); 
            equiposTorneos($conexion,$idTorneo);
          }elseif($tipoPart=="Individual"){
            require_once("../php/tablasUsuariosInscriptos.php"); 
            usuariosTorneos($conexion,$idTorneo);
          }
          desconectarBD($conexion);
          ?>
        </div>
        ...
        <div class="row">
          ...
          <?php
          require_once("../php/conexionBD.php");
          require_once("../php/tablaGrupos.php");
          $conexion = conectar();
          mostrarGrupos($conexion,$idTorneo);
          desconectarBD($conexion);
          ?>
        ...
        <div class="row">
          ...
          <?php
          require_once("../php/conexionBD.php");
          require_once("../php/tablaRondas.php");
          $conexion = conectar();
          mostrarRondas($conexion,$idTorneo);
          desconectarBD($conexion);
          ?>
          <!--Mostrando Grupos o no END-->
        ...
        <div class="row">
          <?php
          require_once("../php/tablaPremios.php");
          $conexion = conectar();
          premiosTorneo($conexion,$idTorneo);
          ?>
        </div>
        <!-- Premios END -->
