          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="card card-primary">
                ...
                <!-- Form START -->
                <form role="form" action="<?php echo $urlDB; ?>/php/modificarJuego.php?id=<?php echo $idJuego; ?>" method="POST">
                  ...
                  <div class="row card-body">
                    ...
                    <div class="form-group col-6">
                      ...
                      <input type="text" class="form-control" id="juego" name="juego" value="<?php echo $nombreJuego; ?>">
                    </div>
                    ...
                    <div class="form-group col-6">
                      ...
                      <select class="form-control" name="plataforma">
                        <option value="PC" <?php if ($plataforma == "PC") {
                                              echo "selected";
                                            } ?>>PC</option>
                        <option value="PS3/4" <?php if ($plataforma == "PS3/4") {
                                                echo "selected";
                                              } ?>>PS3/4</option>
                        <option value="XBOX" <?php if ($plataforma == "XBOX") {
                                                echo "selected";
                                              } ?>>XBOX</option>
                        <option value="MOBILE" <?php if ($plataforma == "MOBILE") {
                                                  echo "selected";
                                                } ?>>MOBILE</option>
                        <option value="Multi Plataforma" <?php if ($plataforma == "Multi Plataforma") {
                                                            echo "selected";
                                                          } ?>>Multi Plataforma</option>
                      </select>
                    </div>
                    ...
                    <div class="form-group col-6">
                      ...
                      <textarea class="form-control" rows="3" id="descripcionJuego" name="descripcionJuego"><?php echo $descripcionJuego; ?></textarea>
                    </div>
                ...
                <form class="form-horizontal" method="POST" action="<?php echo $urlDB; ?>/php/eliminarJuego.php">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-8">
                        <input type="text" class="form-control" id="idJuego" name="idJuego" readonly value="<?php echo $idJuego; ?>">
                      </div>
                    </div>
                    <!-- Input ID-Juego END -->
