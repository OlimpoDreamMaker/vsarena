          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                <!-- Form START -->
                <form role="form" action="<?php echo $urlDB; ?>/php/modificarProducto.php?id=<?php echo $idProducto?>" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row card-body">
                    ...
                    <div class="form-group col-6">
                      ...
                      <input type="text" class="form-control" name="nombreProducto" id="nombreProducto" value="<?php echo $nombreProducto; ?>" required>
                    </div>
                    ...
                    <div class="form-group col-6">
                      ...
                      <input type="number" class="form-control" name="stockProducto" id="stockProducto" value="<?php echo $stock; ?>" required>
                    </div>
                    ...
                    <div class="form-group col-6">
                      ...
                      <input type="text" class="form-control" name="precioProductoEfectivo" id="precioProductoEfectivo" value="<?php echo $precioEfectivo; ?>" required>
                    </div>
                    ...
                    <div class="form-group col-6">
                      ...
                      <input type="text" class="form-control" name="precioProductoMonVirtual" id="precioProductoMonVirtual" value="<?php echo $precioMonVirtual; ?>" required>
                    </div>
                    ...
                    <div class="form-group col-6">
                      ...
                      <textarea class="form-control" name="descripcionProducto" id="descrpcionProducto" rows="3" required><?php echo $descripcion; ?></textarea>
                    </div>
            ...
            <div class="col-6">
              <div class="card card-danger">
                ...
                <!-- FORM START -->
                <form class="form-horizontal" method="POST" action="<?php echo $urlDB; ?>/php/eliminarProducto.php?id=<?php echo $idProducto; ?>">
