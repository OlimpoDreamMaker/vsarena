          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">
                ...
                <!-- Card Body START -->
                <div class="card-body">
                  <form id="buscarNoticia" action="/panel/noticias/" method="GET">
                    <div class="row">
                      <div class="col">
                        <label for="fechaInicio">Fecha inicio</label>
                        <input name="fechaInicio" type="date" class="form-control" placeholder="Fecha inicio" required value="<?php echo isset($_GET['fechaInicio']) ? $_GET['fechaInicio'] : "" ?>">
                      </div>
                      <div class="col">
                    ...
                    <div class="row mt-2">
                      <div class="col">
                        <input value="Buscar" type="submit" class="btn btn-primary mb-2">
                      </div>
                    </div>
                  </form>
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      if (isset($_GET['fechaInicio'])) {
                        // Fechas
                        $fechaInicio = soloFecha($_GET['fechaInicio']);
                        $fechaFinal = soloFecha($_GET['fechaFinal']);
                        // ResultSet
                        $rs = noticiasPorFecha($fechaInicio, $fechaFinal);
                        // Impresion de los resultados
                        noticiaDashboard($rs);
                      } else {
                        $conexion = conectar();
                        noticias($conexion, $amigable);
                        desconectar($conexion);
                      }
                      ?>
                    </tbody>
          ...
          <div class="row">
            ...
            <div class="col-6">
              <div class="card card-primary">
                ...
                <!-- Form START -->
                <form class="form-horizontal" method="POST" action="<?php echo $urlDB; ?>/php/crearTag.php">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                <!-- Form START -->
                <form role="form" action="<?php echo $urlDB; ?>/php/crearNoticia.php?autor=1" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row card-body">
                    ...
                    <div class="form-group col-12">
                      ...
                      <div class="card-body pad">
                        <div class="mb-3">
                          <textarea class="textarea" name="contenidoNoticia" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                        </div>
                      </div>
