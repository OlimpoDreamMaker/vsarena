        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            <div class="small-box bg-primary">
              <div class="inner">
                <?php
                require_once("../php/cantidadTorneos.php");
                require_once("../php/conexionBD.php");
                $conexion = conectar();
          ...
          <div class="col-lg-3 col-6">
            <div class="small-box bg-info">
              <div class="inner">
                <?php
                require_once("../php/cantidadTorneosActivos.php");
                $conexion = conectar();
          ...
          <div class="col-lg-3 col-6">
            <div class="small-box bg-success">
              <div class="inner">
                <?php
                require_once("../php/cantidadTorneosConcluidos.php");
                $conexion = conectar();
          ...
          <div class="col-lg-3 col-6">
            <div class="small-box bg-danger">
              <div class="inner">
                <?php
                require_once("../php/cantidadTorneosCancelados.php");
                $conexion = conectar();
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                  <?php
                  require_once("../php/tablaTorneos.php");
                  ?>
                  </tbody>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <!-- Form START -->
              <form role="form" action="<?php echo $url;?>/php/crearTorneo.php" method="POST">
