...
<head>
	...
	<!--END METAS LOCALES-->
	<!--START TITULO-->
	<title>COPA - Próximo Enfrentamiento</title>
	<!--END TITULO-->
</head>
...
<body>
					...
					<div class="info">
						<div class="wrap">
							<ul class="breadcrumbs">
								...
								<li>Prox. Enfrentamiento</li>
							</ul>
							<h1>Prox. Enfrentamiento</h1>
						</div>
					</div>
				</div>
			</div>
	...
	<!--CATEGORIA END-->
	<!--MATCH PAGE TOP START-->
	<div class="match-page-top">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<!--INFORMACION DE ENFRENTAMIENTO START-->
					<div class="upcoming-match-info">
						<!--TEAM-->
						<div class="team">
							<div class="avatar"><img src="<?php echo $urlFE;?>/images/vs_arena/team-logo1.png" alt="match-list-team-img"></div>
							<div class="text">
								Team 1
								<div class="latest">
						...
						<div class="team right">
							<div class="text">
								...
								<div class="latest">
									<div class="latest-title">Latest Results</div>
									<span class="win">V</span>
									<span class="drawn">E</span>
									<span class="win">V</span>
									<span class="lose">P</span>
									<span class="win">V</span>
								</div>
							</div>
							<div class="avatar"><img src="<?php echo $urlFE;?>/images/vs_arena/team-logo2.png" alt="match-list-team-img"></div>
						</div>
					</div>
					<!--INFORMACION DE ENFRENTAMIENTO END-->
				</div>
			</div>
		</div>
	</div>
	<!--MATCH PAGE TOP END-->
	<!--LIVE MACTH STAT START-->
			...
			<div class="row">
				...
				<div class="col-lg-6">
					...
					<div class="statistics">
						<h6>Horario del enfrentamiento</h6>
