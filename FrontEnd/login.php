...
<head>
	...
	<meta property="og:title" content="Login | ArenaGG">
	...
	<meta property="og:url" content="https://www.arenagg.com/es/login">
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8">


	<link rel="alternate" href="https://www.arenagg.com/en/login" hreflang="en">
	<link rel="alternate" href="https://www.arenagg.com/pt/login" hreflang="pt">
	...
	<script src="https://connect.facebook.net/signals/config/320342028472342?v=2.9.20&amp;r=stable" async=""></script>
	<script src="https://connect.facebook.net/signals/config/1567688113267351?v=2.9.20&amp;r=stable" async=""></script>
	<script async="" src="https://connect.facebook.net/en_US/fbevents.js"></script>
	<script type="text/javascript" async="" src="https://www.gstatic.com/recaptcha/releases/oqtdXEs9TE9ZUAIhXNz5JBt_/recaptcha__es.js"></script>
...
<body id="" class="">
	...
	<div class="canvas ">
		...
		<style type="text/css">
			.canvas {
				background: url('/bundles/arenaapp/img/login/bg2_arenagg.jpg') fixed;
		...
		<div class="container-fluid full-background">
											...
											<div class="row">
												<div class="col-xs-12 center">
													...
													<a href="/oauth/connect/google" class="sign-up-button google-button">
														...
														<span class="sign-up-button-text">Entra con Google</span>
													</a>
												</div>
          ...
          11.9-11.9V11.9C216 5.3 210.7 0 204.1 0z"></path>
														...
														<span class="sign-up-button-text">Entra con Facebook</span>
													</a>
												</div>
											</div>
											<div class="divider">
											...
											<form action="/es/login_check" method="POST" autocomplete="false" name="login" id="loginForm">
												<input type="hidden" name="_csrf_token" value="TEqqr8QvnmqAeTZ4nkk7M0YtUZ0RyBmJOtS7hFy5N7w">
												<div class="group big first-element">
													<div class="row">
														<div class="col-xs-12">
															<div class="form-group">
																<i class="mdi mdi-alert"></i>
																<input name="_username" value="" type="text" required="false" autocorrect="off" autocapitalize="off" autocomplete="false" autofocus="enabled">
																<span class="bar"></span>
																<label>E-mail o nick</label>
															</div>
														</div>
														<div class="col-xs-12">
															<div class="form-group">
																<i class="mdi mdi-alert"></i>
																<input name="_password" value="" type="password" autocomplete="off" required="false">
																<span class="bar"></span>
														...
														<div class="col-xs-5">
															<div class="form-group" style="margin-bottom: 30px;">
																<i class="mdi mdi-alert"></i>
																<div class="input-form-group" required="false">
																	<a class="checkbox left-side js-_remember_me" required="false">
																		<div class="label">
																			<input type="checkbox" name="_remember_me" value="1" checked="">
																			<span class="check">
																				<span class="bg"></span>
																			</span>
																			<span class="inline-ellipsis">Recuérdame</span>
																		</div>
																	</a>
																</div>
															</div>
														</div>
														<input class="hidden" name="referer" value="" type="hidden">
														<div class="col-xs-7">
															<a href="/es/login-recovery" class="remember-link">¿Problemas para iniciar la sesión?</a>
														</div>
														<div class="col-xs-12">
															<button type="submit" id="submitLogin" class="btn btn-primary ripplelink js-background-button js-login-submit js-submit-enter">Entra con tu cuenta</button>
														</div>
													</div>
												</div>
											</form>
											...
											<script type="text/javascript">
												$(function() {
													var remember = new Input('_remember_me', 'checkbox', '_remember_me', 1, [{
														'0': 'No recordarme',
														'1': 'Recordarme'
													}]);
												});
											...
											<script type="text/javascript">
												$(document).ready(function() {
													_bindEnterSubmit('body', '.js-submit-enter');
												})
											</script>
										</div>
									</div>
							...
							<div class="bottom-link">
								¿Todavía sin cuenta? <a href="/es/register"><strong>Regístrate ahora</strong></a>
							</div>
						</div>
